...
class Drawing154 extends Component {
  ...
  constructor(props) {
      ...
      lineLen: this.getRandomInt(Drawing154.minLineLen, Drawing154.initSquareSize),
		};
	}
  ...
  randomize() {
    let canExtend = this.getRandomBool();
    let squareSize = this.getRandomInt(Drawing154.minSquareSize,
  ...
  randomizeAndGetLineLen(squareSize, canExtend) {
    return (previousState, currentProps) => {
      ...
      let lineLen = this.getRandomInt(Drawing154.minLineLen, lineMax);
